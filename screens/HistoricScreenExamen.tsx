...
const HistoricScreenExamen: React.FC = () => {
  ...
  const [data, setData] = useState([
    { name: 'Bonnes réponses', population: 0, color: 'green', legendFontColor: '#7F7F7F', legendFontSize: 9 },
    { name: 'Mauvaises réponses', population: 0, color: 'red', legendFontColor: '#7F7F7F', legendFontSize: 9 },
  ]);

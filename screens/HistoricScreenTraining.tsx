...
const HistoricScreenTraining: React.FC = () => {
    ...
    useEffect(() => {
        const selectedScore = mode === 'training' ? trainingScore: 0;
        setData([
      ...
      }, [trainingScore, mode, totalQuestions]);
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            ...
            <Text style={styles.chartTitle}>Répartition des réponses en {mode === 'training' ? 'Entraînement' : 'Entraînement'} ({selectedTheme})</Text>
            <PieChart
                data={data}
            ...
            <View style={styles.resultsContainer}>
                <Text style={styles.resultsText}>Bonnes réponses : {mode === 'training' ? trainingScore: 0}</Text>
                <Text style={styles.resultsText}>Mauvaises réponses : {totalQuestions - (mode === 'training' ? trainingScore: 0)}</Text>
            </View>
            </View>
        </ScrollView>
    );
